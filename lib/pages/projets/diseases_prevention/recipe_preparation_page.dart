...
class _RecipePreparationPageState extends State<RecipePreparationPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    final prepKey = 'prep_${widget.disease}';
  ...
  Future<void> _savePreparationProgress() async {
    ...
    if (widget.preparationProgress.containsKey(prepKey)) {
      ...
      final data = "${prep['disease']}|${prep['solution']}|${prep['currentStep']}|${prep['startTime']}";
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text("Culture: ${widget.crop}", style: GoogleFonts.roboto(fontSize: 16)),
