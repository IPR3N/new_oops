...
//   final List<OppsModel> sharedPosts; // Liste des posts partagés
...
//     this.sharedFrom, // Peut être null
//     required this.sharedPosts,
//     bool isLiked = false,
//     int likesCount = 0,
//     int sharedPostsCount = 0,
//   })  : this.isLiked = ValueNotifier<bool>(isLiked),
//         this.likesCount = ValueNotifier<int>(likesCount),
//         this.sharedPostsCount = ValueNotifier<int>(sharedPostsCount);
...
//               .toList() ??
//           [],
//       likedBy: (json['likes'] as List<dynamic>?)
//               ?.map<int>((like) =>
//                   like['user'] != null ? like['user']['id'] as int : 0)
//               .toList() ??
//           [],
//       isLiked: false,
//       likesCount: (json['likes'] as List<dynamic>?)?.length ?? 0,
//       sharedFrom: json['sharedFrom'] != null
//           ? OppsModel.fromJson(json['sharedFrom'])
//           : null,
//       sharedPosts: (json['sharedPosts'] as List<dynamic>?)
//               ?.map((post) => OppsModel.fromJson(post))
//               .toList() ??
//           [],
//       sharedPostsCount: (json['sharedPosts'] as List<dynamic>?)?.length ?? 0,
//     );
//   }
...
//       'sharedPosts': sharedPosts.map((post) => post.toJson()).toList(),
//       'sharedPostsCount': sharedPostsCount.value,
//     };
//   }
...
//       isLiked: isLiked?.value ?? this.isLiked.value,
//       likesCount: likesCount?.value ?? this.likesCount.value,
//       sharedPostsCount: sharedPostsCount?.value ?? this.sharedPostsCount.value,
//     );
//   }
// }
